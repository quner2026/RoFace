...
set_target_properties(openvino::runtime PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "\$<\$<AND:\$<CXX_COMPILER_ID:GNU>,\$<VERSION_LESS:\$<CXX_COMPILER_VERSION>,9.1>>:stdc++fs>;\$<\$<AND:\$<CXX_COMPILER_ID:Clang>,\$<VERSION_LESS:\$<CXX_COMPILER_VERSION>,9.0>>:c++fs>"
)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/OpenVINOTargets-*.cmake")
